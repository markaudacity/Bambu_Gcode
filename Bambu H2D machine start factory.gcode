...
;M960 S5 P1 ; turn on logo lamp H2 doesn't have one, wtf -a
G90
...
M104 S{nozzle_temperature_initial_layer[initial_no_support_extruder]-80} ;start hotend heating
M1002 gcode_claim_action : 2
M140 S[bed_temperature_initial_layer_single] ;start bed heatbed heating
...
{endif}
M106 S255 ; turn on fan to cool the nozzle ;BUT WHY - audi

;===== bed leveling ==================================
M1002 judge_flag g29_before_print_flag
M190 S[bed_temperature_initial_layer_single]; ensure bed temp
M109 S140 A; wait for hotend to cool off?
...
{if (overall_chamber_temperature >= 40)}
    ...
    M191 S[chamber_minimal_temperature] ; wait for chamber temp
{endif}
...
G90
G1 X250 F60000
;M109 S{nozzle_temperature_initial_layer[initial_no_support_extruder]}; ça SUFFIT non MAIS -audi
M83
